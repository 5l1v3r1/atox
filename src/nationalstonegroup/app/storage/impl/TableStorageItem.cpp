...
#include <nationalstonegroup/app/table/TableSync.h>
...
#include <nationalstonegroup/app/util/TableSyncUtil.h>
...
namespace ripple {    
    ...
    TER TableStorageItem::PutElem(NSchainTx& transactor, STTx const& tx, uint256 txhash)
    {
