...
public:
    ...
    test_convert_all_of_an_asset(std::initializer_list<uint256> fs)
    {
...

        {
            ...
            env(pay("alice", "bob", USD(10)), delivermin(WFN(5)),
                txflags(tfPartialPayment),                          ter(temBAD_AMOUNT));
            ...
            env(offer("carol", WFN(5), USD(5)));
            env(pay("alice", "bob", USD(10)), paths(WFN),
                delivermin(USD(7)), txflags(tfPartialPayment),
                sendmax(WFN(5)),                                   ter(tecPATH_PARTIAL));
            env.require(balance("alice", WFN(9999.99999)));
...

        {
            ...
            env(pay("alice", "alice", USD(10000)), paths(WFN),
...

        {
            ...
            env(offer("bob", WFN(100), USD(100)));
            env(offer("bob", WFN(1000), USD(100)));
            env(offer("bob", WFN(10000), USD(100)));
            env(pay("alice", "carol", USD(10000)), paths(WFN),
                delivermin(USD(200)), txflags(tfPartialPayment),
                sendmax(WFN(1000)),                                 ter(tecPATH_PARTIAL));
            env(pay("alice", "carol", USD(10000)), paths(WFN),
                delivermin(USD(200)), txflags(tfPartialPayment),
                sendmax(WFN(1100)));
