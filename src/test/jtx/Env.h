...
public:
    ...
    */
    ...
    /** Returns the WFN balance on an account.
...
public:
    ...
    /** Create a new account with some WFN.
        ...
        Effects:
            ...
            The account's WFN balance is set to amount.

            Generates a test that the balance is set.

        @param amount The amount of WFN to transfer to
                      each account.
