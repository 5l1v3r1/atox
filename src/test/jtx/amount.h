...
The decision was made to accept amounts of drops and WFN
using an int type, since the range of WFN is 100 billion
...
/** Represents an WFN or IOU quantity
    This customizes the string conversion and supports
    WFN conversions from integer and floating point.
*/
struct PrettyAmount
{
private:
...
struct WFN_t
{
    ...
    */
    ...
    /** Returns an amount of WFN as STAmount

        @param v The number of WFN (not drops)
    */
    /** @{ */
    ...
    friend
    BookSpec
    operator~ (WFN_t const&)
    {        
        return BookSpec( wfnAccount(),
            wfnCurrency() );
    }
};

/** Converts to WFN Issue or STAmount.

    Examples:
        WFN         Converts to the WFN Issue
        WFN(10)     Returns STAmount of 10 WFN
*/
extern WFN_t const WFN;

/** Returns an WFN STAmount.
