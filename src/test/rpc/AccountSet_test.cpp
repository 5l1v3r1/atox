...
public:
    ...
    void testNullAccountSet()
    {
        ...
        env.fund(WFN(10000), noripple(alice));
    ...
    void testBadInputs(bool withFeatures)
    {
        ...
        auto jt = fset(alice, asfDisallowWFN);
        jt[jss::ClearFlag] = asfDisallowWFN;
        ...
        jt = fset(alice, asfDisallowWFN);
        jt[sfFlags.fieldName] = tfAllowWFN;
        env(jt, ter(temINVALID_FLAG));
