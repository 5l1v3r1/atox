...
public:
    ...
    void testLedgerType()
    {
        ...
        env(offer(Account{"bob0"}, USD(100), WFN(100)));
...

        {
            ...
            jv[jss::Amount] = WFN(50).value().getJson(0);
...

        {
            ...
            jv[jss::Amount] = WFN(100).value().getJson (0);
