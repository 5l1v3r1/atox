...
protected:
    ...
    AccountID     account_;
    WFNAmount     mFeeDue;
    WFNAmount     mPriorBalance;  // Balance before fees.
    WFNAmount     mSourceBalance; // Balance after fees.
...
private:
    void setSeq ();
    TER payFee ();
    void claimFee (WFNAmount& fee, TER terResult, std::vector<uint256> const& removedOffers);
