...
int run (int argc, char** argv)
{
    ...
    beast::setCurrentThreadName ("nschaind: main");
    ...
    {
        std::cerr << "nschaind: Incorrect command line syntax." << std::endl;
    ...
    beast::setCurrentThreadName ("nschaind: rpc");
...
int main (int argc, char** argv)
{
    ...
    static_assert (gccver >= 50100,
        "GCC version 5.1.0 or later is required to compile nschaind.");
#endif

    static_assert (BOOST_VERSION >= 105700,
        "Boost version 1.57 or later is required to compile nschaind");
