...
transResults()
{
    ...
    results
    {
        ...
        { tecNO_DST,                 { "tecNO_DST",                "Destination does not exist. Send WFN to create it."                            } },
        { tecNO_DST_INSUF_WFN,       { "tecNO_DST_INSUF_WFN",      "Destination does not exist. Too little WFN sent to create it."                 } },
        ...
        { tecUNFUNDED_ADD,           { "tecUNFUNDED_ADD",          "Insufficient WFN balance for WalletAdd."                                       } },
        { tecUNFUNDED_OFFER,         { "tecUNFUNDED_OFFER",        "Insufficient balance to fund created offer."                                   } },
        { tecUNFUNDED_PAYMENT,       { "tecUNFUNDED_PAYMENT",      "Insufficient WFN balance to send."                                             } },
		...
		{ temBAD_FEE,                { "temBAD_FEE",               "Invalid fee, negative or not WFN."                                             } },
		...
		{ temBAD_SEND_WFN_LIMIT,     { "temBAD_SEND_WFN_LIMIT",    "Malformed: Limit quality is not allowed for WFN to WFN."                       } },
		{ temBAD_SEND_WFN_MAX,       { "temBAD_SEND_WFN_MAX",      "Malformed: Send max is not allowed for WFN to WFN."                            } },
		{ temBAD_SEND_WFN_NO_DIRECT, { "temBAD_SEND_WFN_NO_DIRECT","Malformed: No Ripple direct is not allowed for WFN to WFN."                    } },
		{ temBAD_SEND_WFN_PARTIAL,   { "temBAD_SEND_WFN_PARTIAL",  "Malformed: Partial payment is not allowed for WFN to WFN."                     } },
		{ temBAD_SEND_WFN_PATHS,     { "temBAD_SEND_WFN_PATHS",    "Malformed: Paths are not allowed for WFN to WFN."                              } },
